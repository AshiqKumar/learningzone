...
cout << "\n=> Socket server has been created..." << endl;
    ...
    */
    ...
    /* ------------- LISTENING CALL ------------- -------------*
        ...
        i.e the number of connections that the server can handle while the process is handling a particular 
        connection. The maximum size permitted by most systems is 5.
    /------------------------------------------------------------*/
